...
import com.adrian.servodriver.utils.NetworkUtils;
...
//        mHandler.sendEmptyMessageDelayed(0, 2000);
        if (NetworkUtils.isConnected()) {
            WelcomeActivityPermissionsDispatcher.needsMaxsinePermmissionWithPermissionCheck(this);
        } else {
